...
if page=="Start Here":
    ...
    st.divider()
    st.write("""
    These three questions are related to Machine Learning,
    but they represent different leaning problems.

    During this session we will understand the difference
    between them and also see how the Streamlit can help us
...
#AI and Machine Learning
    ...
    where it fits into the larger world of Artificial Intelligence.
    """)
    ...
    langugae undersanding, planning and decision-making.
    """)
